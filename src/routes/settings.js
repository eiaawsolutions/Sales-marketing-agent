...
router.put('/', (req, res) => {
  const allowedKeys = ['ai_provider', 'ai_model', 'api_key', 'smtp_host', 'smtp_port', 'smtp_user', 'smtp_pass', 'from_email', 'admin_password', 'stripe_secret_key', 'stripe_publishable_key', 'ai_credit_balance'];
